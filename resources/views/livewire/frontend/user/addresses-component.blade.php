    ...
    <form wire:submit.prevent="{{ $editMode ? 'updateAddress' : 'storeAddress' }}" x-show="formShow" @click.away="formShow = false">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="full_name">Full name</label>
                <input class="form-control form-control-lg" wire:model="full_name" type="text" placeholder="Enter your full name">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="address" type="text" placeholder="Enter your full name">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="zip_code" type="text" placeholder="Enter your full name">
