    ...
    <div class="row">
        <div class="col-md-6">
            <div class="checkout-form-list">
                {!! Form::label('text', 'Full name*') !!}
                {!! Form::text('shipping_full_name', old('shipping_full_name'), ['placeholder' => 'Full name']) !!}
                @error('shipping_full_name')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
        </div>
        <div class="col-md-12">
            <div class="checkout-form-list">
