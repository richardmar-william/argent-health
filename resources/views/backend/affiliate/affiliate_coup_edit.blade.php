...
@php
  $aff_detail = DB::table('affiliate_coupon_details')->where('coupon_id',$coupon_detail->id)->whereNotNull('value')->pluck('cat_id');
  $cat_name = DB::table('categories')->whereIn('id', $aff_detail )->get();
  $aff_commission = DB::table('affiliate_coupon_details')->where('coupon_id',$coupon_detail->id)->whereNotNull('value')->pluck('commission');
@endphp
...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form action="{{ route('admin.affiliate_coup_update') }}" method="POST" id="couponForm">
            @csrf
            <input type="hidden" name="id" value="{{ $coupon_detail->id }}">
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        @foreach($cat_name as $cats)
                            <option value="{{ $cats->id }}" selected>{{$cats->name}}</option>
                        @endforeach    
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="code" type="text" name="code" value="{{ $coupon_detail->code }}">
            ...
            <div class="row">
                <div class="col-6">
                        <div class="form-group addval">
                            ...
                            <input class="form-control hidval" id="value" type="text" name="values[]" value="">
                ...
                <div class="col-6">
                    <div class="form-group addcom">
                        ...
                        <input class="form-control hidcom" id="commission" type="number" name="commissions[]" value="{{ $aff_commission }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="start_date" type="date" name="start_date"
                               value="{{ $coupon_detail->start_date }}" >
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="expire_date" type="date" name="expire_date"
                               value="{{ $coupon_detail->expire_date }}" >
