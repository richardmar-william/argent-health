                ...
                <div class="row">
                    ...
                    <div class="form-group">
                            ...
                            <select name="subscription_duration" id="subscription_duration" class="form-control">
                                <option value="">---</option>
                                <option value="1" {{ old('subscription_duration') == "1" ? 'selected' : null }}>1 Month</option>
                                <option value="3" {{ old('subscription_duration') == "3" ? 'selected' : null }}>3 Months</option>
                                <option value="6" {{ old('subscription_duration') == "6" ? 'selected' : null }}>6 Months</option>
                            </select>
