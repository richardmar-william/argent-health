                ...
                <tr class="">
                    ...
                    <td>
                        <form method="post" action="{{ route('admin.pages.destroy',$page->id) }}" id="page-delete-{{ $page->id }}">
                            ...
                            @method('DELETE')
                            @can('delete-page')
                                <button type="submit" class="btn  btn-danger" onclick="if (confirm('Are You sure to Delete This Page?')) { document.getElementById('page-delete-{{ $page->id }}').submit(); } else { return false; }">
