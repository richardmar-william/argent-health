...
class OrderService
{
    public function createOrder($request)
    {
        ...
        $order = Order::create([
            ...
            'user_id' => auth()->id(),
            'user_address_id' => isset($request['userAddressId']) ? $request['userAddressId'] : "",
            'shipping_company_id' => isset($request['shippingCompanyId']) ? $request['shippingCompanyId'] : "",
            'payment_method_id' => isset($request['paymentMethodId']) ? $request['paymentMethodId'] : "",
            ...
            'currency' => 'USD',
            'order_status' => 0,
            'session_id'=>session('my_random_string'),
        ]);
